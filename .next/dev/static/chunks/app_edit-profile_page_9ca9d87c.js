...
"[project]/app/edit-profile/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ToastProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ToastProvider.js [app-client] (ecmascript)");
...
function EditProfilePage() {
    ...
    const { showToast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ToastProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
    const MAX_SOCIAL = 4;
    ...
    const [avatarPath, setAvatarPath] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [bannerPath, setBannerPath] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const [uploadingBanner, setUploadingBanner] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditProfilePage.useEffect": ()=>{
            const load = {
                "EditProfilePage.useEffect.load": async ()=>{
                    setError('');
                    setSuccess('');
                    try {
                        ...
                        if (!res.ok) {
                            const data = await res.json().catch({
                                "EditProfilePage.useEffect.load": ()=>({})
                            }["EditProfilePage.useEffect.load"]);
    ...
    const onSubmit = async (e)=>{
        ...
        if (showPasswordFields) {
            if (!newPassword || !confirmPassword) {
                ...
                showToast('กรุณากรอกรหัสผ่านใหม่และยืนยันรหัสผ่าน', {
                    type: 'error'
                });
                return;
            }
        ...
        try {
            ...
            setError(e.message || 'เกิดข้อผิดพลาด');
            showToast(e.message || 'บันทึกไม่สำเร็จ', {
                type: 'error'
            });
        } finally{
            setSaving(false);
    ...
    const addSocialLink = ()=>{
        setSocialLinks((prev)=>{
            if (prev.length >= MAX_SOCIAL) {
                showToast(`เพิ่มได้สูงสุด ${MAX_SOCIAL} รายการ`, {
                    type: 'error'
                });
                return prev;
            }
    ...
    const updateSocialLink = (index, patch)=>{
        setSocialLinks((prev)=>prev.map((item, i)=>i === index ? {
                    ...item,
                    ...patch
                } : item));
    };
    ...
    const handleBannerUpload = async (e)=>{
        ...
        if (!allowedTypes.includes(file.type)) {
            ...
            showToast('อนุญาตเฉพาะรูปภาพ JPEG/PNG/WebP/GIF', {
                type: 'error'
            });
            return;
        }
        ...
        try {
            ...
            showToast('อัปโหลดแบนเนอร์สำเร็จ', {
                type: 'success'
            });
            if ("TURBOPACK compile-time truthy", 1) {
                window.dispatchEvent(new Event('profile:updated'));
    ...
    const handleAvatarUpload = async (e)=>{
        ...
        if (!allowedTypes.includes(file.type)) {
            ...
            showToast('อนุญาตเฉพาะรูปภาพ JPEG/PNG/WebP', {
                type: 'error'
            });
            return;
        }
        ...
        try {
            ...
            setError(e.message || 'เกิดข้อผิดพลาด');
            showToast(e.message || 'อัปโหลดไม่สำเร็จ', {
                type: 'error'
            });
        } finally{
            setUploading(false);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                uid ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: "uid-label",
                                    children: [
                                        "UID: ",
                                        uid
                ...
                uploadingBanner && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    style: {
                        fontSize: '0.85rem',
                        color: 'var(--primary)',
                        marginTop: '10px'
                    },
                    children: "กำลังอัปโหลดแบนเนอร์..."
                }, void 0, false, {
                    fileName: "[project]/app/edit-profile/page.js",
                    lineNumber: 314,
                    columnNumber: 11
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: showPasswordFields ? 'ยกเลิกการเปลี่ยนรหัสผ่าน' : 'เปลี่ยนรหัสผ่าน'
                                    }, void 0, false, {
                                        fileName: "[project]/app/edit-profile/page.js",
                                        lineNumber: 384,
                                        columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                socialLinks.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "social-empty",
                                                    children: "ยังไม่มี Social Networks"
                                                }, void 0, false, {
                                                    fileName: "[project]/app/edit-profile/page.js",
                                                    lineNumber: 418,
                                                    columnNumber: 21
                                                }, this) : socialLinks.map((item, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(EditProfilePage, "IAVamaYfkfkli5SQbkOdQ4b8Yuw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSession"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ToastProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
_c = EditProfilePage;
var _c;
...
//# sourceMappingURL=app_edit-profile_page_9ca9d87c.js.map