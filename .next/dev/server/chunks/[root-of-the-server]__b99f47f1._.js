...
async function GET() {
    try {
        ...
        const conversations = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].conversation.findMany({
            where: {
                participants: {
                    some: {
                        userId
...
async function POST(request) {
    try {
        ...
        const userId = session.user.id;
        console.log('API POST /api/conversations:', {
            userId,
            otherUserId
        });
        if (otherUserId === userId) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Invalid otherUserId (Self-chat not allowed)'
            }, {
                status: 400
            });
        }
        // Check if user exists
        const otherUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findUnique({
            where: {
                id: otherUserId
            },
            select: {
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].conversation.findFirst({
            where: {
                AND: [
                    {
                        participants: {
        ...
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].conversation.create({
            data: {
                clientId: userId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b99f47f1._.js.map