...
"[project]/app/api/conversations/[id]/messages/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, context) {
    try {
        ...
        if (messageIdsToMark.length > 0) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].message.updateMany({
                where: {
                    id: {
                        in: messageIdsToMark
                    }
...
async function POST(request, context) {
    try {
        ...
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].$transaction(async (tx)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__44bcdbbe._.js.map