...
"[project]/app/api/conversations/[id]/block/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, context) {
    try {
        ...
        const existingBlock = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].block.findUnique({
            where: {
                blockerId_blockedId: {
                    blockerId: userId,
        ...
        if (existingBlock) {
            // Unblock
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].block.delete({
                where: {
                    id: existingBlock.id
                }
            });
            ...
            // Block
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].block.create({
                data: {
                    blockerId: userId,
                    blockedId: targetUserId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__63f3d0ba._.js.map