...
"[project]/app/api/arts/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const arts = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].art.findMany({
            orderBy: {
                createdAt: 'desc'
            },
            include: {
...
async function POST(request) {
    try {
        ...
        const art = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].art.create({
            data: {
                title,
                description,
                price,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dbbf2bf4._.js.map