...
"[project]/app/api/jobs/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const jobs = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].job.findMany({
            orderBy: {
                createdAt: 'desc'
            },
            include: {
...
async function POST(request) {
    try {
        ...
        const client = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findUnique({
            where: {
                id: session.user.id
            },
            select: {
        ...
        const job = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].job.create({
            data: {
                title,
                description,
                contact,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f1e0c558._.js.map